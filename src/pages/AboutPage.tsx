...
const milestones = [
  { year: '2023', event: 'Founded with a mission to simplify grocery shopping' },
  { year: '2023', event: 'First 100 happy households' },
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div>
              ...
              <div className="space-y-4 text-gray-600 text-lg leading-relaxed">
                ...
                <p>
                  Starting from a small operation in our local community, we built a service around what people actually needed—speed, reliability, fair pricing, and a human touch. No complicated apps to download. No lengthy registration processes. Just a quick message and a delivery at your door in <span className="font-semibold">45 minutes or less</span>.
                </p>
                <p>
              ...
              <div className="relative bg-white p-4 rounded-3xl shadow-2xl">
                ...
                <div className="absolute -bottom-6 -left-6 bg-white p-4 rounded-2xl shadow-xl animate-float">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-bold text-gray-900">45 Min Delivery</p>
